...
module.exports = {
    ...
    commands: ["python2.4 * < input.txt", "python2.5 * < input.txt", "python2.6 * < input.txt", "python2.7 * < input.txt", "python3.1 * < input.txt",
               "python3.2 * < input.txt", "python3.3 * < input.txt", "python3.4 * < input.txt", "python3.5 * < input.txt", "python3 * < input.txt",
              "gcc * -std=c90 ; ./a.out < input.txt", "gcc * -std=iso9899:199409 ; ./a.out < input.txt", "gcc * -std=c99 ; ./a.out < input.txt",
              "gcc * -std=c11 ; ./a.out < input.txt", "gcc * -std=gnu90 ; ./a.out < input.txt", "gcc * -std=gnu99 ; ./a.out < input.txt",
              "gcc * -std=gnu11 ; ./a.out < input.txt", "g++ * -std=c++98 ; ./a.out < input.txt", "g++ * -std=c++03 ; ./a.out < input.txt",
              "g++ * -std=c++11 ; ./a.out < input.txt", "g++ * -std=c++14 ; ./a.out < input.txt", "g++ * -std=c++17 ; ./a.out < input.txt",
              "g++ * -std=gnu++98 ; ./a.out < input.txt", "g++ * -std=gnu++03 ; ./a.out < input.txt", "g++ * -std=gnu++11 ; ./a.out < input.txt",
              "g++ * -std=gnu++14 ; ./a.out < input.txt", "g++ * -std=gnu++17 ; ./a.out < input.txt", "javac * ; java ** < input.txt", "javac * ; java ** < input.txt",
